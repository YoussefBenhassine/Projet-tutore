...
for col in numeric_cols:
    ...
    plt.tight_layout()
    plt.savefig(f"uploads/hist_{col}.png")
    plt.show()
...
for col in numeric_cols:
    ...
    plt.tight_layout()
    plt.savefig(f"uploads/boxplot_{col}.png")
    plt.show()
...
plt.tight_layout()
plt.savefig("uploads/correlation_matrix.png")
plt.show()
...
plt.savefig("uploads/pairplot_numeric.png")
plt.show()
...
for col in cat_cols:
    ...
    plt.tight_layout()
    plt.savefig(f"uploads/count_{col}.png")
    plt.show()
